...
class Seq2Seq(nn.Module):
    ...
    def forward(self, source_ids=None, source_mask=None, target_ids=None, target_mask=None, args=None):
        ...
        if target_ids is not None:
            ...
            # Decoder input: tgt_embeddings, encoder_output, encoder_mask
            # tgt_embedding: word embedding of target sequence.
            # encoder_output: hidden states of encoder output.
            # encoder_mask: mask of encoder input to mask attention.
